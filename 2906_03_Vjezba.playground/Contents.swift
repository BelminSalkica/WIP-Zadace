...
var newArray = [1,3,4,5,6,7,8,2,4]
var secondArray = [3,44,43,64,75,443,345]
// Kombinovanje
var cominedArray = newArray + secondArray
// Pristupanje i modifikovanje 
firstArray.isEmpty
print("First array has \(firstArray.count) elements but newArray have \(newArray.count) and second array is empty: \(secondArray.isEmpty)")
firstArray.append("Test")
print("Now first array is empty: \(firstArray.isEmpty) and contains \(firstArray.count)")
// Ubacivanje elemenata unutar niza
newArray.insert(666, atIndex: 4)
newArray.removeAtIndex(4)
newArray.removeLast()
...
var shopingList: [String] = ["Jaje", "Mlijeko", "Hljeb"]
if shopingList.isEmpty {
    print("Shopping list is emptz")
} else {
    print("Shpping list contains: \(shopingList.count) items")
}


// Set
var someSet = Set<String>()
print("someSet is Set with collection of strings and contains \(someSet.count)")

var favouriteGenres: Set = ["Rock", "Electro", "Ex/yu"]
...
airports.count
/*
 variable[key] pristupanje putem kljuca
 variable[key] = value  izmjena vrijednosti
 variable[key] = nil brisanje vrijednosti
 */
